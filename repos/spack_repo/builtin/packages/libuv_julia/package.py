...
class LibuvJulia(AutotoolsPackage):
    ...
    version("1.48.0-af4172e", commit="af4172ec713ee986ba1a989b9e33993a07c60c9e") # for Julia v1.12
    version("1.48.0", commit="ca3a5a431a1c37859b6508e6b2a288092337029a") # for Julia v1.11
